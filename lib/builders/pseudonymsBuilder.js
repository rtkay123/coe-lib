...
async function pseudonymsBuilder(manager, pseudonymsConfig) {
    console.log('instantiating [pseudonyms] database');
    ...
    console.log('waiting for [pseudonyms] database to be ready');
    try {
        const dbReady = await (0, readyCheck_1.isDatabaseReady)(manager._pseudonymsDb);
        console.log(`[pseudonyms] db ok: ${dbReady}`);
        ...
        console.log(`[pseudonyms] db err: ${dbManager_1.readyChecks.PseudonymsDB}`);
    }
