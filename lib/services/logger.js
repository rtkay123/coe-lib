...
class LoggerService {
    ...
    trace(message, serviceOperation, callback) {
        this.#trace(message, serviceOperation, callback);
    }
    log(message, serviceOperation, callback) {
        this.#info(message, serviceOperation, callback);
    }
    warn(message, serviceOperation, callback) {
        this.#warn(message, serviceOperation, callback);
    }
    error(message, innerError, serviceOperation, callback) {
        this.#error(message, innerError, serviceOperation, callback);
    }
    debug(message, serviceOperation, callback) {
